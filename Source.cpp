...
int main() {
	...
	while (!doexit) {
		...
		if (ev.type == ALLEGRO_EVENT_TIMER) {//note from mo: this was in the wrong place... all physics should be *inside* the timer section
			if (bouncer3_x < 0 || bouncer3_x > 640 - 10) {
		...
		if (redraw && al_is_event_queue_empty(event_queue)) {
			...
			al_draw_text(font, al_map_rgb(250, 250, 250), 150, 50, ALLEGRO_ALIGN_CENTER, "0");
			al_draw_text(font, al_map_rgb(250, 250, 250), 500, 50, ALLEGRO_ALIGN_CENTER, "0");
